...
public class ColorHelper {
    ...
    public final static String TAB_BAR = ChatColor.GRAY.toString() + ChatColor.STRIKETHROUGH.toString() + "-------------------";
    public final static String GUI_BAR = ChatColor.DARK_GRAY.toString() + ChatColor.STRIKETHROUGH.toString() + "-»-------------------------«-";
    public final static String CHAT_BAR = ChatColor.GRAY.toString() + ChatColor.STRIKETHROUGH.toString() + "------------------------------------------------";
    public final static String HOLOGRAM_BAR = ChatColor.GRAY.toString() + ChatColor.STRIKETHROUGH.toString() + "-------------------------------------";
    ...
    public static String detranslate(String in) {
        return in.replace("§", "&");
    }
